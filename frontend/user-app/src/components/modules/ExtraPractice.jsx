    ...
    return (
      <div className="max-w-3xl mx-auto pt-16 text-center">
        ...
        <p className="text-lg text-slate-500 font-medium mb-10 max-w-xl mx-auto">
          Our AI teacher will instantly generate brand new, never-before-seen vocabulary words matching your selected grade band! You can practice as much as you want.
        </p>
        <button 
